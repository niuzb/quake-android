...
class SDL_Keys
{
	public static String [] names = null;//this is soreted by value of the name
	public static Integer [] values = null;
	public static boolean Using_SDL_1_3 = false;
	public static String [] namesSorted = null;//name was sorted
	public static Integer [] namesSortedIdx = null;//name --> code
	public static Integer [] namesSortedBackIdx = null;//index is code code 
	// -->name index
