...
public class Globals {
	...
	public static int VERSION = 0x53;
	// Should be zip file
...
//		getExternalFilesDir() 
		...
		dirpath = url.getAbsolutePath();
		 ...
		 Log.i("doom", "the data path is "+dirpath);
		Globals.outFilesDir = dirpath+"/doom";
//		Globals.outFilesDir = dirpath;
		return Globals.outFilesDir;
	}
