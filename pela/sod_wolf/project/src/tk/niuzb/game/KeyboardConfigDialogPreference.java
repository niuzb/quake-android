...
public class KeyboardConfigDialogPreference extends DialogPreference implements OnKeyListener {
	...
	protected void onBindDialogView(View view) {
		...
		if (mSharedPrefs != null) {
			...
			Log.v("wolf", "fire "+mFirePrefKey+" value:"+mFireKeyCode);
			Log.v("wolf", "door "+mDownPrefKey+" value:"+mDoorKeyCode);
	...
	protected void onDialogClosed(boolean positiveResult) {
		...
		if (positiveResult) {
			...
			Log.v("wolf", ""+mFirePrefKey+" value:"+mFireKeyCode);
			editor.putInt(mFirePrefKey, mFireKeyCode);
			Log.v("wolf", ""+mDoorPrefKey+" value:"+mDoorKeyCode);
