...
void CL_AdjustAngles (void)
{
	...
	if (1/*in_klook.state & 1*/)//EDIT BY niuzb
	{
		
		V_StopPitchDrift ();
		cl.viewangles[PITCH] -= speed*cl_pitchspeed.value * 1/*CL_KeyState (&in_forward)*/;
		cl.viewangles[PITCH] += speed*cl_pitchspeed.value * 1/*CL_KeyState (&in_back)*/;
	}
